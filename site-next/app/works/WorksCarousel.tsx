...
const demos: Demo[] = [
  {
    category: "WEB予約システム",
    title: "WEB予約フォーム",
    desc: "メニュー選択 → カレンダー → 時間 → 情報入力 → 完了まで、実際の予約フローを体験できます。スマホでもそのまま動作します。",
    demoUrl: "/booking",
    iframeUrl: "/booking",
    tag: "DEMO",
  },
  {
    category: "予約管理・顧客管理（CRM）",
    title: "管理ダッシュボード",
    desc: "本日の予約タイムライン・予約一覧・顧客カルテまで。実際にクリックして操作できます。クライアントに管理画面として納品するUIです。",
    demoUrl: "/demo-dashboard",
    iframeUrl: "/demo-dashboard",
    tag: "DEMO",
  },
  {
    category: "LINE連携・アカウント作成代行",
    title: "LINE予約デモ",
    desc: "LINEのトーク画面から予約・変更・キャンセルができる仕組みです。リッチメニューのデザインから自動応答設定まで代行します。",
    demoUrl: null,
    tag: "準備中",
  },
];
