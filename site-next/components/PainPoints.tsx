...
export default function PainPoints() {
  ...
  return (
    <section className="pp-section" style={{ background: "#f0f4f8", padding: "7rem clamp(1.5rem,5vw,6rem)" }}>
      <div style={{
        maxWidth: 1100,
        margin: "0 auto",
        display: "grid",
        ...
        {/* ── 左カラム：見出し＋説明 ── */}
        <div>
          <div className="sec-label">CHALLENGE</div>
          ...
          <p style={{
            ...
            オーナー様は日々、さまざまな課題に追われています。
            AI時代を迎えた今でも、新しい技術へのキャッチアップに時間を割けなかったり、
            社内にエンジニアを1から育てる余裕がないケースがほとんどです。
            そんな悩みを、WeldexはWEB制作からシステム開発・AI活用まで、まるっと一社で解決します。
          </p>
        ...
        {/* ── 右カラム：LINEチャット ── */}
        <div style={{ borderRadius: 16, overflow: "hidden", boxShadow: "0 4px 32px rgba(12,26,53,0.13)" }}>
          {/* ヘッダー */}
          <div style={{
            background: "#0c1a35",
            ...
            <div style={{
              ...
              fontSize: "1.15rem", flexShrink: 0, color: "#fff", fontWeight: 700,
