...
const steps = [
  ...
  { num: "02", title: "ご提案・お見積もり", desc: "ヒアリング内容をもとに提案書と見積書を作成。ご確認いただきます。", days: "Day 2〜3" },
  { num: "03", title: "契約・着手", desc: "契約締結後、着手金50%のご入金確認で制作を開始します。", days: "Day 4〜5" },
  { num: "04", title: "デザイン・制作", desc: "デザイン確認→コーディング→テストの順で進めます。修正は都度対応。", days: "Week 2〜3" },
  { num: "05", title: "公開・引き渡し", desc: "最終確認後に公開。残金50%のご請求と同時に1ヶ月間の無料サポートが始まります。", days: "Week 4〜" },
];
